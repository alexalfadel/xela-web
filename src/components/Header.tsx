          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-center space-x-8">
              ...
              <button 
                ...
                className="bg-primary-accent text-white px-6 py-2 rounded-lg hover:bg-opacity-90 hover:scale-110 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 font-medium focus:outline-none focus:ring-2 focus:ring-primary-accent focus:ring-offset-2"
              >
                Get In Touch
              </button>
              <a
                href="tel:+16504651676"
                className="bg-secondary-accent text-white p-2 rounded-lg hover:bg-opacity-90 hover:scale-110 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 focus:outline-none active:outline-none flex items-center"
                aria-label="Call us"
              >
                <Phone size={20} />
              </a>
