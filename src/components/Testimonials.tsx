  ...
  return (
    <section id="testimonials" className="bg-surface-bg py-28 scroll-mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg relative hover-lift">
            ...
            <div className="flex justify-between items-center mt-8">
              <button
                ...
                className="p-3 rounded-full bg-gray-100 hover:bg-primary-accent hover:text-white transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary-accent focus:ring-offset-2 hover-lift"
              ...
              <div className="flex space-x-2">
                {testimonials.map((_, index) => (
                  <button
                    ...
                    className={`w-3 h-3 rounded-full transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary-accent focus:ring-offset-2 hover:scale-125 ${
